...
class MainWindow(QMainWindow):
    ...
    def angle_calculation_direct(self): 
        ...
        if 1==1:
            ...
            if 1 ==1:
                ...
                painter.drawLine(point1xmin, y1,point2xmax, y_pred_final_tail[0])
    ...
    def show_secondary_buttons(self):
        ...
        self.slider_maximum_size.setMinimum(int(self.fish_size)/3)
    ...
    def peaks(self):          
        ...
        cvariation = lambda x: np.std(x, ddof=1) / np.mean(x) * 100     
    ...
    def heat_map(self):
        ...
        #self.heat_map_start()
        #self.velocity_calculation() #HHHHHHHHHHHERREE
    ...
    def aceleration(self):
        ...
        print(self.acceleration_message)
